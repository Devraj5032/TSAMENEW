  ...
  const getData = async (event) => {
    ...
    if (assetID) {
      try {
        ...
        const res = await axios.post(
          "/server/api/supervisor/asset-status/",
          filters
        );
        ...
        <Box>
          <form onSubmit={getData}>
            ...
            >
              <FormControl
                w={"400px"}
                isDisabled={supervisor || localityId || assetType}
              >
              ...
              <FormControl
                w={"400px"}
                isRequired
                isDisabled={assetID || !supervisor}
              >
                <FormLabel>Select Locality</FormLabel>
                <Select value={localityId} onChange={handleLocalityChange}>
          ...
          {!isMobileOrTablet && showTable && (
            <TableForAssetStatus tableData={data} />
          )}
